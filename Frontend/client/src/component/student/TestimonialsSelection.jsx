                        ...
                        <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
                            ...
                            <div className='p-5 pb-7'>
                                <div className='flex gap-0.5'>
                                    {[...Array(5).map((_,i)=>(<img key={i} src={i< Math.floor(testimonial.rating) ? assets.star : assets.star_blank}  alt="star " />))]}
                                </div>
...
export default  TestimonialsSelection;